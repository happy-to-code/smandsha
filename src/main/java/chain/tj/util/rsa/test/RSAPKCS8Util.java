package chain.tj.util.rsa.test;
...
public class RSAPKCS8Util {
     ...
     * 初始化公钥和秘钥
     *
     * @param keySize 64的整倍数,范围：512～2048,建议是1024或2048
     * @throws Exception
     */
    private void initKey(Integer keySize) throws Exception {
        RSAPublicKey rsaPublicKey;
        RSAPrivateKey rsaPrivateKey;
        // 1、初始化密钥
        KeyPairGenerator keyPairGenerator;
        try {
            keyPairGenerator = KeyPairGenerator.getInstance(KEY_ALGORITHMS);
     ...
     * @return 签名值
     */
    public static String sign(String content, RSAPrivateKey privateKey, String encode) throws Exception {
